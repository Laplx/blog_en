...
其中的 $H = \ln V(x,t)$ 为对数价值。$P_1$ 可代入我们的 European Call，$P_2$ 为 $B_2$  和 $S_2$ 的一个 Portfolio，$r_1=r_2$；利用上式，可以如法炮制得到新版的 Relativistic Black-Scholes 方程
...
令 $\gamma = 1$，方程退化为我们熟知的样子。结合边界条件，解得
